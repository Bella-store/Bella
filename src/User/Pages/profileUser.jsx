...
function ProfileUser() {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div
        ref={sidebarRef}
        className={`h-full p-4 relative flex flex-col justify-between ${sidebarOpen ? "w-[250px]" : "w-[80px]"} transition-all duration-300 bg-white shadow-lg`}
      >
        <div className="flex flex-col m">
          ...
          <div className="flex flex-col gap-4 mt-6 w-full">
            ...
            >
              <CiUser size={24} />
              <span className={`ml-2 ${!sidebarOpen && "hidden"}`}>User Info</span>
            </NavLink>
            <NavLink
            ...
            >
              <CiHeart size={24} />
              <span className={`ml-2 ${!sidebarOpen && "hidden"}`}>Favourites</span>
            </NavLink>
            <NavLink
            ...
            >
              <GrTask size={24} />
              <span className={`ml-2 ${!sidebarOpen && "hidden"}`}>My Orders</span>
            </NavLink>
          </div>
        </div>
