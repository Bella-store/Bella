  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gray-100 h-60 flex items-center justify-center">
        <img
          src="/public/cart-page-header.jpg"
          alt="Cart Banner"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <h1 className="relative text-6xl font-bold text-gray-800">Cart</h1>
      </div>
      ...
      <div className="container mx-auto py-8 px-4 max-w-7xl">
        <div className="flex flex-col mt-8 lg:flex-row lg:space-x-8">
          ...
          <div className="lg:max-w-sm w-full bg-white shadow-md rounded p-4 mt-8 lg:mt-0 text-sm md:text-base">
            ...
            <button className="mt-4 w-full bg-gray-800 text-white py-4 rounded hover:bg-gray-700 transition text-sm md:text-base">
              Proceed to Checkout
            </button>
          </div>
        </div>
